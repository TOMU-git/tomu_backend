...
export interface ILessonService {
  create(dto: CreateLessonDto, file: Express.Multer.File): Promise<ResData<Lesson>>;
  ...
  update(id: ID, dto: UpdateLessonDto, file?: Express.Multer.File): Promise<ResData<Lesson>>;
