...
import { HomeworkProgressAlreadyExistException, HomeworkProgressNotFoundException } from './exception/homework-progress.exception';
...
export class HomeworkProgressService implements IHomeworkProgressService {
  ...
  async create(dto: CreateHomeworkProgressDto): Promise<ResData<HomeworkProgress>> {
    console.log(
    ...
    const foundHomework = await this.homeworkService.findOneById(dto.homeworkId); // HomeworkService orqali darsni topamiz
