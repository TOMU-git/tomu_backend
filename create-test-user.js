...
async function createTestUser() {
  try {
    ...
    console.log("   User ID:", loginResponse.data.data.data.id);
    console.log(
      "   Device Management:",
      loginResponse.data.data.data.deviceManagementEnabled,
    );
    console.log("   Max Devices:", loginResponse.data.data.data.maxDevices);
    console.log("");
    ...
    const accessToken = v2LoginResponse.data.data.tokens.access_token;
